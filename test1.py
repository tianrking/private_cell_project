...
#  训练模型保存地址
model_path = r"E:\ww\CTsegthor\model\model-1out-stage4\weights.63-0.00792.hdf5"
#model_path = r"D:\ww\lwd\data_only\Data\yuanhe_heren\model\temp_clip\weights.63-0.0196.hdf5"
#  测试数据路径
test_iamge_path = r"E:\ww\CTsegthor\test\image-all1"   #单词写错image
#  结果保存路径
save_path = r"E:\ww\CTsegthor\test\pre-unet-stage4"
#  测试数据数目
...
output_size = (512, 512)
#  测试数据标签路径
test_label_path = r"E:\ww\CTsegthor\test\label-all"
