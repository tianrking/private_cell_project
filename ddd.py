...
filepath = r'D:\dengSJ\chengang\seg_thor\data\data_source\Patient_40'  # 读取本代码同个文件夹下所有的nii格式的文件
filenames = os.listdir(filepath)
imgfile = r'D:\dengSJ\chengang\seg_thor\data\data_source\Patient_40'
