...
from tensorflow.python.keras.layers import Input, BatchNormalization, Conv2D, MaxPooling2D, Dropout, concatenate, UpSampling2D
...
def unet(pretrained_weights = None, input_size = (512, 512, 3), classNum = 4, learning_rate = 1e-4):
