...
def Deeplabv3(pretrained_weights=None, alpha=1., backbone="xception", downsample_factor=16, input_size=(512, 512, 3), classNum=5, learning_rate=1e-5,
              ):
    ...
    if backbone == "xception":
        ...
        #   主干部分x       [30,30,320]
        # ----------------------------------#
        x, atrous_rates, skip1 = mobilenetV2(
            img_input, alpha, downsample_factor=downsample_factor)
    else:
        raise ValueError(
    ...
    #   将加强特征边上采样
    # -----------------------------------------#
    x = Lambda(lambda xx: tf.compat.v1.image.resize_bilinear(
